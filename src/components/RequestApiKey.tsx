...
const RequestApiKey: FunctionComponent<Props> = (props) => {
    ...
    return <div className="container md:max-w-2xl">
        <div className="flex flex-col gap-6 items-center">
            ...
            <Paragraph>Your haven&apos;t requested an API key yet.</Paragraph>
        </div>
        ...
        <form onSubmit={createNewApiKey} className="mt-6 sm:flex sm:items-center" action="#">
            <div className="relative rounded-md shadow-md sm:min-w-0 sm:flex-1">
                {apiKey ? (<CopyButton valueToCopy={apiKey} type="button"
                                       className="absolute inset-y-0 right-0 animate-in fade-in duration-300"/>) : null}
                <Input readOnly value={apiKey ?? ""} placeholder="Request and API key to display here."/>
            </div>
